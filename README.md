...
```
cd existing_repo
git remote add origin https://gitlab.com/mealzo-backend/cid-bakend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/mealzo-backend/cid-bakend/-/settings/integrations)
